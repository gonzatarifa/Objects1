...
public class TestSupermercado {
	public static void main(String[] args) {
		...
		System.out.println(c1.agregarItem(1, s1.traerProducto(1), 20));
		System.out.println(c1.agregarItem(2, s1.traerProducto(2), 4));
		System.out.println(c1.agregarItem(3, s1.traerProducto(3), 40));
		System.out.println(" ");
		...
		System.out.println(" ");
		System.out.println("Agregamos al carrito items: ");
		System.out.println(s1.traerCarrito(1).agregarItem(1, s1.traerProducto(1), 300));
		System.out.println(s1.traerCarrito(2).agregarItem(2, s1.traerProducto(2), 400));
		System.out.println(s1.traerCarrito(3).agregarItem(3, s1.traerProducto(3), 500));
		System.out.println(" ");
		System.out.println("Traemos los carritos por producto: ");
		System.out.println(s1.traerCarrito(s1.traerProducto(2)));
		System.out.println(" ");
		...
		try {
			System.out.println(s1.traerCarrito(1).eliminarItem(s1.traerProducto(1), 300));
			System.out.println(s1.traerCarrito(2).eliminarItem(s1.traerProducto(2), 400));
			System.out.println(s1.traerCarrito(3).eliminarItem(s1.traerProducto(3), 500));
		} catch (Exception e) {
		...
		try {
			...
			System.out.println(c1.eliminarItem(s1.traerProducto(2), 4));
