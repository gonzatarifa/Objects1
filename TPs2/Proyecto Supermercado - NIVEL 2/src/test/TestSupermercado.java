...
public class TestSupermercado {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(supermercado1.agregarProducto("Acelga", 200.0f));
		} catch (Exception e) {
		...
		System.out.println(supermercado1.traerProducto(4));
		...
		System.out.println(supermercado1.traerProducto("Acelga"));
		...
		System.out.println(supermercado1.traerCliente(4));
		...
		System.out.println(supermercado1.traerCliente("Alejandro Torrents"));
		...
		System.out.println(" ");
		System.out.println("Agrego los items al carrito por producto: ");
		try {
			System.out.println(supermercado1.traerCarrito(1).agregarItem(supermercado1.traerProducto(1), 50));
			System.out.println(supermercado1.traerCarrito(2).agregarItem(supermercado1.traerProducto(2), 60));
			System.out.println(supermercado1.traerCarrito(3).agregarItem(supermercado1.traerProducto(3), 70));
			System.out.println(supermercado1.traerCarrito(4).agregarItem(supermercado1.traerProducto(4), 80));
		...
		System.out.println(" ");
		System.out.println("Traigo los itemcarrito de carritos: ");
		System.out.println(supermercado1.traerCarrito(1).traerItemCarrito(1));
		System.out.println(supermercado1.traerCarrito(2).traerItemCarrito(2));
		System.out.println(supermercado1.traerCarrito(3).traerItemCarrito(3));
		System.out.println(supermercado1.traerCarrito(4).traerItemCarrito(4));
		

		System.out.println(" ");
		System.out.println("Traigo carrito por cliente: ");
